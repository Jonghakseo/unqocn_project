  ...
  state = {
    ...
    media_arr: [
      ...
      },
      {
        ...
        type: 'img',
        desc:
          '작품의 규칙을 볼 수 있는 창입니다.<br/><br/>' +
          '게임의 전체적인 규칙을 안내해주는 게임규칙, 카드의 사용 규칙을 안내해주는 사용규칙, 카드 각각의 효과를 안내하는 카드 규칙이 있습니다.<br/><br/>' +
          '실행창 상단에 위치한 도움말 - 게임규칙 버튼을 통해 열람할 수 있습니다.',
      },
      {
        active: false,
        src: JavaImage5,
        type: 'img',
        desc:
          '모든 카드의 설명을 볼 수 있는 창입니다.<br/><br/>' +
          '카드의 이름, 상성, 효과 등을 확인할 수 있습니다.<br/><br/>' +
          '실행창 상단에 위치한 도움말 - 카드목록 버튼을 통해 열람할 수 있습니다.',
      },
      {
        active: false,
        src: JavaImage3,
        ...
        desc:
          '게임 플레이 화면입니다.<br/><br/> ' +
          '카드 목록, 주사위 상태, 게임판, 게임 로그, 현금 현황 확인이 가능합니다.<br/><br/>' +
          ' 하단 버튼을 통해 게임 조작이 가능합니다.',
      },
        ...
        <article className="portfolio_text_section">
          ...
          <div className="portfolio_text_wrapper">
            ...
            <span className="portfolio_text_content">
              ...
              <br />
              <br />
              시작 시 카드를 들고 시작하여 매 턴 카드를 드로우합니다. 땅 위에 건물 카드, 건물 카드
              위에 세입자 카드를 사용하여 돈을 벌 수 있고, 스킬 카드를 사용해 내 땅과 건물을
              보호하거나 상대의 땅과 건물, 세입자를 공격 할 수 있습니다.
              <br />
              <br />
              매 5턴 마다 게임 전체에 영향을 주는 이벤트가 발생하며 이를 이용해서 전략적인 카드
              사용을 노려볼 수 있습니다.
              <br />
              <br />
